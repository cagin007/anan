...
exports.run = async (client, message, args) => {
  ...
  this.fighting = new Set();
	...
	if (!opponent) return message.reply("<a:elite_dnd:786178421502902293> Oynamak istediğin kişiyi etiketlemelisin!")
  
  if (opponent.bot) return message.reply('<a:elite_dnd:786178421502902293> Botlar ile oynayamazsın!');
  if (opponent.id === message.author.id) return message.reply('<a:elite_dnd:786178421502902293> Kendin ile düello atamazsın!');
		if (this.fighting.has(message.channel.id)) return message.reply('<a:elite_dnd:786178421502902293> Kanal başına sadece bir düello meydana gelebilir.');
