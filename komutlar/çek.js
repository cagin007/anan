...
if(!message.mentions.members.first()) return message.channel.send(new Discord.MessageEmbed().setColor('RED').setTitle('Bir hata oldu!').setDescription('Kullanıcı Etiketleyerek dener misin?'));
